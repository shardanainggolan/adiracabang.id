export default function Parallax() {
    return (
        <section
            ...
            data-image-src="/img/photos/bg1.jpg">
                ...
                <div className="flex flex-wrap mx-[-15px]">
                    <div className="lg:w-10/12 xl:w-10/12 xxl:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto">
                        <a href="./assets/media/movie.mp4"
                            ...
                            data-glightbox>
                            <i className="icn-caret-right ml-[0.15rem] !relative z-[2] before:content-['\e900'] text-[calc(1.355rem_+_1.26vw)]"></i>
                        </a>
                        <h2 className="xl:text-[2rem] text-[calc(1.325rem_+_0.9vw)] !leading-[1.2] font-DMSerif font-normal tracking-normal lg:!px-10 xl:!px-16 xxl:!px-10 text-white">
